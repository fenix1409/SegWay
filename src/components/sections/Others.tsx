...
const Others = () => {
    ...
    return (
        <div className="px-[174px] bg-white mb-[60px]">
            <h1 className="text-[50px] leading-[60px] font-bold text-[#323941] mb-[21px] text-center">OTHER MODELS</h1>
            <p className="text-[18px] leading-[21px] text-[#323941] text-center mb-[49px]">Check out the entire line of Segway scooters</p>
            <ul className="flex items-baseline justify-center gap-[3px] flex-wrap">
                {scooters.map((item: ScooterType) => (
                    <li key={item.id} className="w-[237px] h-[281px] text-center">
                        ...
                        <button className="w-[129px] py-[13px] inline-block border-[1px] border-[#C6C6C6] text-[13px] leading-[15px] text-[#C6C6C6] hover:border-[#009EFF] hover:bg-[#009EFF] hover:text-white duration-200">SEE MORE</button>
                    </li>
                ))}
            </ul>
        </div>
