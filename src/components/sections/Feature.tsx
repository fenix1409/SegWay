        ...
        <div>
            <div className='bg-[#F5F5F5] pb-[73px]'>
                ...
                <div className="pl-[281px] pr-[258px]">
                    <h1 className='text-[50px] leading-[59px] font-semibold text-[#323941] mb-[81px] text-center'>IMPRESSIVE FEATURES</h1>
                    <ul className='flex items-center gap-[100px] justify-center flex-wrap'>
                        <li className='w-[127px] text-center inline-block'>
                            ...
                            <p className='text-[18px] leading-[21px] text-[#999999]'>Pneumatic Tires</p>
                        </li>
                        <li className='w-[130px] text-center inline-block'>
                            ...
                            <p className='text-[18px] leading-[21px] text-[#999999]'>Front LED Lights</p>
                        </li>
                        <li className='w-[134px] text-center inline-block'>
                            ...
                            <p className='text-[18px] leading-[21px] text-[#999999]'>Max Speed</p>
                        </li>
                        <li className='w-[154px] text-center inline-block'>
                            ...
                            <p className='text-[18px] leading-[21px] text-[#999999]'>Max Range</p>
                        </li>
                        <li className='w-[100px] text-center inline-block'>
                            ...
                            <p className='text-[18px] leading-[21px] text-[#999999]'>Hill Grade</p>
                        </li>
                        <li className='w-[123px] text-center inline-block'>
                            ...
                            <p className='text-[18px] leading-[21px] text-[#999999]'>Water-Resistant</p>
                        </li>
                        <li className='w-[110px] text-center inline-block'>
                            ...
                            <p className='text-[18px] leading-[21px] text-[#999999]'>Fast Charging</p>
                        </li>
                        <li className='w-[104px] text-center inline-block'>
                            ...
                            <p className='text-[18px] leading-[21px] text-[#999999]'>Battery</p>
                        </li>
                    </ul>
                </div>
            </div>
            <div className="pl-[211px] pr-[207px]">
                <h2 className='text-[50px] leading-[59px] font-semibold text-[#323941] text-center mt-[43px]'>KickScooter overview SEGWAY Ninebot Kickscooter MAX</h2>
